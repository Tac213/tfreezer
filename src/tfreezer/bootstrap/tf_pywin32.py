...
def install() -> None:
    ...
    pywin32_ext_paths = [os.path.join(sys._stdlib_dir, pywin32_ext_path) for pywin32_ext_path in pywin32_ext_paths]
    ...
    pywin32_system32_path = os.path.join(sys._stdlib_dir, "pywin32_system32")
    ...
    if not os.path.isdir(pywin32_system32_path):
        ...
        # sub-directory. In the latter case, the pywin32 DLLs should be in `sys._stdlib_dir`, and nothing
